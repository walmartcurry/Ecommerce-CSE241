...
public class App extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        c1.setBalance(1000);
        Supplier Nada = new Supplier("NADA", "AY7aga", "Nada dairy and more");
        Supplier almara3y = new Supplier("almara3y", "almara3y","AlMara3y");
        Database.suppliers.add(almara3y);
        c1.addIntrests("Electronics & Devices");
        c1.addIntrests("Clothing & Fashion");
        for(int i = 0 ; i < c1.getIntrests().size() ; i++){
            System.out.println(c1.getIntrests().get(i).gettype());
        }
